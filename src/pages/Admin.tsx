            ...
            <div className="mt-6 space-y-6">
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                {selectedUser.onboarding_completed ? (
                  <Badge className="bg-emerald-500/20 text-emerald-400 border-emerald-500/30"><CheckCircle2 className="h-3 w-3 mr-1" />Onboarding Completo</Badge>
                ) : (
                  <Badge className="bg-yellow-500/20 text-yellow-400 border-yellow-500/30"><Clock className="h-3 w-3 mr-1" />Onboarding Pendente</Badge>
                )}
              </div>
